...
class HiddenTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testHiddenField()
    {
        ...
        $this->assertEquals(
            '<input type="hidden" name="someProperty" id="someProperty" value="foo" />',
            $this->form->get('someProperty')->widget()
        );
    }

    public function testHiddenFieldWithDefaultData()
    {
        $this->object->someProperty = 'some value';
        $this->form->initialize();
        $this->assertEquals(
            '<input type="hidden" name="someProperty" id="someProperty" value="some value" />',
            $this->form->get('someProperty')->widget()
        );
    }
}
